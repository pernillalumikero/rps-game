...
const Result = ({ computerChoice, userChoice, playerOne, playerTwo, gameMode}) => {
  ...
  let computerImgs =['https://cdn.pixabay.com/photo/2012/04/24/17/17/hand-40512_960_720.png', 'https://cdn.pixabay.com/photo/2012/04/11/16/11/sign-language-28717_960_720.png', 'https://cdn.pixabay.com/photo/2014/04/02/10/18/palm-303412_960_720.png']
  ...
  return (
    <div>
      <div className='wrapper'>
        ...
        <div name="result-text"><Logic userChoice={userChoice} computerChoice={computerChoice} playerOne={playerOne}/></div>
    </div>
  )
}
